...
let pizzarr=["Arabian Ranch","Jamacan bbq","Fajita"];
for(var i=0;i<pizzarr.length;i++){
console.log(pizzarr[i]);}

for(var i=0;i<pizzarr.length;i++){
    console.log(`I like ${pizzarr[i]} Pizza!!`);}
console.log(`I really Love Pizza a lot`);